  ...
  return (
    <div className={`header ${classname}`}>
      <div className="header-logo">
        <img src={portLogo} alt="" className="portfolio-logo" />
      </div>
      {menuToggle && (
        <AiOutlineClose
          className="header-nav-listIcon closeButton"
      ...
      <div className="responsive-menu">
        ...
        <ul className="header-nav-links">
          <li onClick={() => getSection(document.getElementById("about"))}>
            About
          </li>
          <li onClick={() => getSection(document.getElementById("work"))}>
            Work
          </li>
          <li>
            <a
          ...
          <div className="social-links-header">
            <a
              href="https://github.com/Minesh6684"
              target="_blank"
              rel="noreferrer"
            >
              <FiGithub />
            ...
            <a
              href="https://www.linkedin.com/in/minesh-tandel-5a66bb1b1/"
              target="_blank"
              rel="noreferrer"
            >
              <FiLinkedin />
            ...
            <a
              href="mailto:minesh9174@gmail.com"
              target="_blank"
              rel="noreferrer"
            >
              <FiMail />
      ...
      {!menuToggle && (
        <VscListSelection
          className="header-nav-listIcon openButton"
